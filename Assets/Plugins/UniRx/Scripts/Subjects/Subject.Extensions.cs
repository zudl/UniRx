...
namespace UniRx
{
    ...
    public static class Subject
    {
        ...
        public static ISubject<TSource, TResult> Synchronize<TSource, TResult>(this ISubject<TSource, TResult> subject)
        {
            if (subject == null)
            {
        ...
        /// <returns>Subject whose messages are synchronized.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="subject"/> is <c>null</c>.</exception>
        public static ISubject<TSource> Synchronize<TSource>(this ISubject<TSource> subject)
        {
            if (subject == null)
            {
                throw new ArgumentNullException("subject");
        ...
        public static ISubject<TSource, TResult> Synchronize<TSource, TResult>(this ISubject<TSource, TResult> subject, IScheduler scheduler)
        {
            if (subject == null)
            {
                throw new ArgumentNullException("subject");
        ...
        /// <returns>Subject whose messages are synchronized and whose observers are notified on the given scheduler.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="subject"/> or <paramref name="scheduler"/> is <c>null</c>.</exception>
        public static ISubject<TSource> Synchronize<TSource>(this ISubject<TSource> subject, IScheduler scheduler)
        {
            if (subject == null)
            {
                throw new ArgumentNullException("subject");
